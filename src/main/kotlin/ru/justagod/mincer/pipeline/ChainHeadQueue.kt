...
class ChainHeadQueue(
    ...
    fun process(mincer: Mincer, bytecode: ByteArray, lastModificationTime: Long, name: String): MincerResult {
        try {
            ...
            return MincerResult(bytecode, false)
        } catch (e: Exception) {
    ...
    private fun doProcess(mincer: Mincer, bytecode: ByteArray, name: String, skipped: Boolean): MincerResult {
        ...
        val modified = (pipeline.worker as SubMincer<Any, Any>)
                .process(
                        WorkerContext(
                                reference,
                                info,
        ...
        if (modified) {
            ...
            return MincerResult(writer.toByteArray(), true)
        } else return MincerResult(bytecode, false)
    }
